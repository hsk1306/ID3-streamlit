...
st.title("ID3 Decision Tree (Manual Implementation) 🌳")
...
outlook_input = st.selectbox("Select Outlook", data['Outlook'].unique())
humidity_input = st.selectbox("Select Humidity", data['Humidity'].unique())

sample = {
    'Outlook': outlook_input,
